...
bool Turtlebot3MotorDriver2::readEncoder(int32_t &left_value, int32_t &right_value)
{
...
bool Turtlebot3MotorDriver2::writeVelocity(int64_t left_value, int64_t right_value)
{
